      ...
      <div className="nav-inner">
        <div className="nav-logo" style={{ color: logoColor }}>
          <img
            src="/logo.png"
            alt="McQueen Realty"
            style={{ height: '38px', width: 'auto', filter: light ? 'none' : 'invert(1) brightness(2)' }}
          />
        </div>
      ...
      <div style={{
        ...
        <div>
          <img
            src="/logo.png"
            alt="McQueen Realty"
            style={{ height: '44px', width: 'auto', filter: 'invert(1) brightness(1.8)', marginBottom: '0.6rem' }}
          />
            ...
            <div key={head}>
              ...
              {links.map(l => (
                <div key={l} style={{ marginBottom: '0.6rem' }}>
                  <a href="#" style={{ fontFamily: "'Jost',sans-serif", fontSize: '0.8rem', color: 'rgba(255,255,255,0.28)', fontWeight: 300, transition: 'color 0.22s' }}
