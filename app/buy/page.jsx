...
const SHARED_CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .nav-wrap.nav-dark { background: transparent; border-bottom-color: transparent; }
  ...
  .search-bg { position: absolute; inset: 0; background-size: cover; background-position: center 30%; opacity: 0.6; }
  ...
  return (
    <>
      ...
      <div className="page-header">
        <div className="page-header-bg" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1613977257363-707ba9348227?w=1800&q=80')" }} />
      ...
      <section className="idx-section">
        <div className="idx-context-bar">
          <div className="idx-context-left">
            <div>
              ...
              <div className="idx-context-title">Live MLS Listings · Buy</div>
            </div>
        ...
        <div className="idx-clip">
          <div className={`idx-loader ${idxLoaded ? 'hidden' : ''}`}>
            ...
            <div className="idx-loader-label">Loading Listings</div>
          </div>
          <iframe
            src={IDX_URL}
            frameBorder="0"
            title="McQueen Realty — Buy"
            allowFullScreen
